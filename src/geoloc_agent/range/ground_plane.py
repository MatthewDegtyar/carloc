...
DEFAULT_ATTITUDE_SIGMA_RAD = np.radians(0.5)
...
airframe with a good IMU and RTK holds attitude to a few tenths of a degree;
0.5 deg is a defensible default that is not flattering to the hardware. It is
kept explicit rather than folded into a fudge factor because the whole point of
the sigma is that it tracks the thing actually limiting accuracy."""
